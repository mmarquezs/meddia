...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(yaml
     ...
     ;;        c-c++-default-mode-for-headers t)
     ;; markdown
     multiple-cursors
     treemacs
     ;; org
